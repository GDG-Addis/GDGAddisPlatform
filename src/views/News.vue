  ...
  <v-container class="pa-4 my-0" >
    ...
    >
      ...
      <v-flex xs12 sm8 md10 lg10 class="pa-2 py-4 px-3">
        <span class="google-font mt-1 display-1" style="font-size:240%;color:white;">News Section Is Underconstruction  <v-icon style="font-size:120%;color:white;">mdi-bulldozer</v-icon> </span>
        <p
